...
<body>
			<div class="row">
			<div class="col-sm-12">
				<h1 class="page-header">用户修改密码</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<form id="eidtUserPassword" class="form-horizontal"
								action="${ctx }/user/updatemyPass" method="post">
								...
								<div class="form-group">
									<label for="input01" class="control-label col-sm-2">原密码：</label>
									<div class="controls col-sm-8">
								...
								<div class="form-group">
									<label for="input01" class="control-label col-sm-2">新密码：</label>
									<div class="controls col-sm-8">
								...
								<div class="form-group">
									<label for="input01" class="control-label col-sm-2">确认新密码：</label>
									<div class="controls col-sm-8">
								...
								<div class="form-actions">
									...
									<div class="col-sm-8">
										<button class="btn btn-primary" type="submit"><span class="fa fa-floppy-o fa-fw"></span> 确认修改密码</button>
									</div>
								</div>
							</form>
						</div>
