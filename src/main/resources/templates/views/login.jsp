...
<body  class="lock-screen">
    <div class="container" >
    	<div class="form-signin">
	        <h1 class="form-signin-heading">Coolook</h1>
	        <div class="login-wrap">
	            <input name="username" id="username" type="text" class="form-control" placeholder="请输入用户名" autofocus>
	            <input name="password" id="password" type="password" class="form-control" placeholder="请输入您的密码">
