...
<SCRIPT type="text/javascript">
		...
		var zNodes =[{id:0,pId:-1,name:"所有功能",open:true}<coolook:tree type="1"/>];
		var code;		
		
		function onCheck(e, treeId, treeNode) {
			$("#menuid").attr("value",treeNode.id );
			$("#menuname").attr("value",treeNode.name );
		}	
		function setCheck() {
	...
	$(document).ready(function(){
		$("#addmenu").on('click', function(e){
			...
			location.href="${ctx}/menu/add?type=add&id=0&pid="+menuid;
		});
		$("#updatamenu").on('click', function(e){
			...
			location.href="${ctx}/menu/add?type=update&id="+menuid+"&pid=0";
		});
		$("#deletmenu").on('click', function(e){
		  var menuid = $("#menuid").val();
		  if(menuid>0){
				location.href="${ctx}/menu/delete?id="+menuid;
			}
		});
	});
	</script>
					...
					<div class="row">
						<form name="addroleform" class="form-horizontal" id="addroleform">
							<div class="form-group">
								<label for="textarea" class="control-label col-sm-2">系统功能树：</label>
							...
							<div class="form-group">
								...
								<div class="controls col-sm-8">
									<input class="input-xlarge disabled" id="menuname" type="text"
							...
							<div class="form-actions">
								...
								<div class="col-sm-8">
									<a href="#" id="addmenu" class="btn btn-primary">添加功能</a>
									<a href="#" id="updatamenu" class="btn btn-info">修改功能</a>
									<a href="#" id="deletmenu" class="btn btn-danger">删除功能</a>
								</div>
							</div>
						</form>
					</div>
